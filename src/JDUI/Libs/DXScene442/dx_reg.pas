...
uses
  ...
  {$endif}
  Classes, Controls, Dialogs, ExtDlgs, SysUtils, Forms, dx_scene, dx_vgcore, Graphics;
...
uses
  dx_dsgn_material, dx_dsgn_particle,
  dx_utils, dx_objects, dx_ani, dx_viewport,
  dx_controls, dx_textbox, dx_vglayer, dx_dynamics, dx_vgdb;
...
procedure Register;
begin
  RegisterComponents('DXScene', [TdxScene, TdxBitmapList, TvxResources, TvxScene, TvxLang, TvxImageList, TdxMaterialDialog, TdxParticleDialog]);
  RegisterNoIcon([
    ...
    TdxBufferLayer, TdxCanvasLayer, TdxObjectLayer,
    // shape 3d
    TdxText3D, TdxPath3D, TdxRectangle3D, TdxEllipse3D,
    // controls
    TdxTextBox3D,
    // dynamics
    TdxParticleEmitter,
    ...
    // deprecated
    TdxVGLayer, TdxScreenCanvasLayer, TdxScreenVGLayer, TdxScreenImage, TdxScreenDummy
  ]);
  ...
  RegisterNoIcon([TvxRectAnimation, 
    ...
    TvxPanel, TvxTabControl, TvxDBLabel, TvxDBTextBox, TvxDBNavigator, TvxDBMemo, 
    TvxDBImage, TvxDBGrid, TvxDesignFrame, TvxSelection, TvxSelectionPoint, TvxInspector, 
