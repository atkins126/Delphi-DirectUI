...
var
  CefLastCallJavaScriptMethodTicket: Cardinal = 0;
  CefExternalMode: Boolean = False;
...
type
  ...
  TCefWindowOpenDisposition = (WOD_UNKNOWN, WOD_SUPPRESS_OPEN, WOD_CURRENT_TAB,
    WOD_SINGLETON_TAB, WOD_NEW_FOREGROUND_TAB, WOD_NEW_BACKGROUND_TAB,
    WOD_NEW_POPUP, WOD_NEW_WINDOW, WOD_SAVE_TO_DISK, WOD_OFF_THE_RECORD,
    WOD_IGNORE_ACTION);
...
type
  ...
  TCefDraggableRegionArray = array
    [0 .. (High(Integer) div SizeOf(TCefDraggableRegion)) - 1]
    of TCefDraggableRegion;
  ...
  TCefMenuId = (
    ...
    MENU_ID_CUSTOM_FIRST = 220, MENU_ID_CUSTOM_LAST = 250,
...
type
  ...
  TCefJsonParserError = (JSON_NO_ERROR = 0, JSON_INVALID_ESCAPE,
    JSON_SYNTAX_ERROR, JSON_UNEXPECTED_TOKEN, JSON_TRAILING_COMMA,
    JSON_TOO_MUCH_NESTING, JSON_UNEXPECTED_DATA_AFTER_ROOT,
    JSON_UNSUPPORTED_ENCODING, JSON_UNQUOTED_DICTIONARY_KEY,
  ...
  TCefScaleFactor = (SCALE_FACTOR_NONE = 0, SCALE_FACTOR_100P,
    SCALE_FACTOR_125P, SCALE_FACTOR_133P, SCALE_FACTOR_140P, SCALE_FACTOR_150P,
    SCALE_FACTOR_180P, SCALE_FACTOR_200P, SCALE_FACTOR_250P, SCALE_FACTOR_300P);
...
type
  ...
  TCefValue = record
    ...
    // set successfully.
    set_string: function(self: PCefValue; const value: PCefString)
      : Integer; stdcall;

    // Sets the underlying value as type binary. Returns true (1) if the value was
    // set successfully. This object keeps a reference to |value| and ownership of
    // the underlying data remains unchanged.
    set_binary: function(self: PCefValue; value: PCefBinaryValue)
      : Integer; stdcall;

    // Sets the underlying value as type dict. Returns true (1) if the value was
    // set successfully. This object keeps a reference to |value| and ownership of
    // the underlying data remains unchanged.
    set_dictionary: function(self: PCefValue; value: PCefDictionaryValue)
      : Integer; stdcall;
  ...
  TCefDictionaryValue = record
    ...
    // this object.
    get_value: function(self: PCefDictionaryValue; const key: PCefString)
      : PCefValue; stdcall;
    ...
    // this object.
    set_value: function(self: PCefDictionaryValue; const key: PCefString;
      value: PCefValue): Integer; stdcall;
  ...
  TCefListValue = record
    ...
    get_value: function(self: PCefListValue; index: Integer)
      : PCefValue; stdcall;
    ...
    // will modify this object.
    set_value: function(self: PCefListValue; index: Integer; value: PCefValue)
      : Integer; stdcall;
  ...
  TCefBrowserHost = record
    ...
    run_file_dialog: procedure(self: PCefBrowserHost; mode: TCefFileDialogMode;
      const title, default_file_path: PCefString;
    ...
    print_to_pdf: procedure(self: PCefBrowserHost; const path: PCefString;
      const settings: PCefPdfPrintSettings;
      callback: PCefPdfPrintCallback); stdcall;
    ...
    get_windowless_frame_rate: function(self: PCefBrowserHost)
      : Integer; stdcall;
    ...
    set_windowless_frame_rate: procedure(self: PCefBrowserHost;
      frame_rate: Integer); stdcall;
  ...
  TCefRequestHandler = record
    ...
    on_open_urlfrom_tab: function(self: PCefRequestHandler;
      browser: PCefBrowser; frame: PCefFrame; const target_url: PCefString;
      target_disposition: TCefWindowOpenDisposition; user_gesture: Integer)
      : Integer; stdcall;
    ...
    // process.
    on_render_view_ready: procedure(self: PCefRequestHandler;
      browser: PCefBrowser); stdcall;
  ...
  TCefContextMenuHandler = record
    ...
    run_context_menu: function(self: PCefContextMenuHandler;
      browser: PCefBrowser; frame: PCefFrame; params: PCefContextMenuParams;
      model: PCefMenuModel; callback: PCefRunContextMenuCallback)
      : Integer; stdcall;
  ...
  TCefDownloadItem = record
    ...
    // The resulting string must be freed by calling cef_string_userfree_free().
    get_original_url: function(self: PCefDownloadItem)
      : PCefStringUserFree; stdcall;
  ...
  TCefSetCookieCallback = record
    ...
    on_complete: procedure(self: PCefSetCookieCallback;
  ...
  TCefDeleteCookiesCallback = record
    ...
    on_complete: procedure(self: PCefDeleteCookiesCallback;
      num_deleted: Integer); stdcall;
  end;
  ...
  TCefCookieManager = record
    ...
    set_cookie: function(self: PCefCookieManager; const url: PCefString;
      const cookie: PCefCookie; callback: PCefSetCookieCallback)
      : Integer; stdcall;
    ...
    delete_cookies: function(self: PCefCookieManager;
      const url, cookie_name: PCefString; callback: PCefDeleteCookiesCallback)
      : Integer; stdcall;
    ...
    set_storage_path: function(self: PCefCookieManager; const path: PCefString;
      persist_session_cookies: Integer; callback: PCefCompletionCallback)
      : Integer; stdcall;
...
{$IFDEF Win32}
    ...
    on_draggable_regions_changed: procedure(self: PCefDragHandler;
      browser: PCefBrowser; regionsCount: NativeUInt;
...
{$ENDIF}
  ...
  TCefRequestContextHandler = record
    ...
    on_before_plugin_load: function(self: PCefRequestContextHandler;
      ...
      plugin_info: PCefWebPluginInfo; plugin_policy: PCefPluginPolicy)
      : Integer; stdcall;
  end;
  ...
  TCefRequestContext = record
    ...
    // object.
    is_sharing_with: function(self, other: PCefRequestContext)
      : Integer; stdcall;
    ...
    // The resulting string must be freed by calling cef_string_userfree_free().
    get_cache_path: function(self: PCefRequestContext)
      : PCefStringUserFree; stdcall;
    ...
    clear_scheme_handler_factories: function(self: PCefRequestContext)
      : Integer; stdcall;
    ...
    purge_plugin_list_cache: procedure(self: PCefRequestContext;
      reload_pages: Integer); stdcall;
  end;
  ...
  TCefPrintHandler = record
    ...
    on_print_start: procedure(self: PCefPrintHandler;
      browser: PCefBrowser); stdcall;
  ...
  TCefSslCertPrincipal = record
    ...
    // The resulting string must be freed by calling cef_string_userfree_free().
    get_display_name: function(self: PCefSslCertPrincipal)
      : PCefStringUserFree; stdcall;

    // Returns the common name.
    // The resulting string must be freed by calling cef_string_userfree_free().
    get_common_name: function(self: PCefSslCertPrincipal)
      : PCefStringUserFree; stdcall;

    // Returns the locality name.
    // The resulting string must be freed by calling cef_string_userfree_free().
    get_locality_name: function(self: PCefSslCertPrincipal)
      : PCefStringUserFree; stdcall;

    // Returns the state or province name.
    // The resulting string must be freed by calling cef_string_userfree_free().
    get_state_or_province_name: function(self: PCefSslCertPrincipal)
      : PCefStringUserFree; stdcall;

    // Returns the country name.
    // The resulting string must be freed by calling cef_string_userfree_free().
    get_country_name: function(self: PCefSslCertPrincipal)
      : PCefStringUserFree; stdcall;

    // Retrieve the list of street addresses.
    get_street_addresses: procedure(self: PCefSslCertPrincipal;
      addresses: TCefStringList); stdcall;

    // Retrieve the list of organization names.
    get_organization_names: procedure(self: PCefSslCertPrincipal;
      names: TCefStringList); stdcall;

    // Retrieve the list of organization unit names.
    get_organization_unit_names: procedure(self: PCefSslCertPrincipal;
      names: TCefStringList); stdcall;

    // Retrieve the list of domain components.
    get_domain_components: procedure(self: PCefSslCertPrincipal;
      components: TCefStringList); stdcall;
  end;
  ...
  TCefResourceBundle = record
    ...
    // The resulting string must be freed by calling cef_string_userfree_free().
    get_localized_string: function(self: PCefResourceBundle; string_id: Integer)
      : PCefStringUserFree; stdcall;
    ...
    // memory and should not be freed. Include cef_pack_resources.h for a listing
    // of valid resource ID values.
    get_data_resource_for_scale: function(self: PCefResourceBundle;
      resource_id: Integer; scale_factor: TCefScaleFactor; out data: Pointer;
      out data_size: NativeUInt): Integer; stdcall;
  end;
  ...
  ICefRunFileDialogCallback = interface(ICefBase)
    ...
    procedure OnFileDialogDismissed(selectedAcceptFilter: Integer;
      filePaths: TStrings);
  end;
  ...
  TOnPdfPrintFinishedProc = {$IFDEF DELPHI12_UP}reference to
  {$ENDIF} procedure(const path: ustring; ok: Boolean);
  ...
  ICefBrowserHost = interface(ICefBase)
    ...
    procedure print;
    procedure PrintToPdf(const path: ustring; settings: PCefPdfPrintSettings;
      const callback: ICefPdfPrintCallback);
    procedure PrintToPdfProc(const path: ustring;
      settings: PCefPdfPrintSettings; const callback: TOnPdfPrintFinishedProc);
    procedure find(identifier: Integer; const searchText: ustring;
      forward, matchCase, findNext: Boolean);
    procedure StopFinding(clearSelection: Boolean);
    procedure ShowDevTools(const windowInfo: PCefWindowInfo;
  ...
  ICefRequest = interface(ICefBase)
    ...
    property FirstPartyForCookies: ustring read GetFirstPartyForCookies
      write SetFirstPartyForCookies;
  ...
  TCefCompletionCallbackProc = {$IFDEF DELPHI12_UP} reference to
  {$ENDIF} procedure;
  ...
  TCefSetCookieCallbackProc = {$IFDEF DELPHI12_UP} reference to
  {$ENDIF} procedure(success: Boolean);
  ...
  TCefDeleteCookiesCallbackProc = {$IFDEF DELPHI12_UP} reference to
  {$ENDIF} procedure(numDeleted: Integer);
  ...
  ICefCookieManager = Interface(ICefBase)
    ...
    procedure SetSupportedSchemesProc(schemes: TStrings;
    ...
    function VisitUrlCookies(const url: ustring; includeHttpOnly: Boolean;
      const visitor: ICefCookieVisitor): Boolean;
    function VisitUrlCookiesProc(const url: ustring; includeHttpOnly: Boolean;
      const visitor: TCefCookieVisitorProc): Boolean;
    function SetCookie(const url: ustring; const name, value, domain,
      path: ustring; secure, httponly, hasExpires: Boolean;
    ...
    function SetCookieProc(const url: ustring;
      ...
      secure, httponly, hasExpires: Boolean; const creation, lastAccess,
      expires: TDateTime; const callback: TCefSetCookieCallbackProc): Boolean;
    ...
    function SetStoragePathProc(const path: ustring;
  ...
  ICefListValue = interface(ICefBase)
    ...
    function SetDictionary(index: Integer;
      const value: ICefDictionaryValue): Boolean;
  ...
  ICefRequestHandler = interface(ICefBase)
    ...
    function OnOpenUrlFromTab(const browser: ICefBrowser;
    ...
    function OnResourceResponse(const browser: ICefBrowser;
      const frame: ICefFrame; const request: ICefRequest;
    ...
    function OnCertificateError(const browser: ICefBrowser;
      certError: TCefErrorcode; const requestUrl: ustring;
      const sslInfo: ICefSslInfo; const callback: ICefRequestCallback): Boolean;
  ...
  ICefDisplayHandler = interface(ICefBase)
    ...
    procedure OnFaviconUrlChange(const browser: ICefBrowser;
      icon_urls: TStrings);
    procedure OnFullScreenModeChange(const browser: ICefBrowser;
      fullscreen: Boolean);
  ...
  ICefRequestContextHandler = interface(ICefBase)
    ...
    function OnBeforePluginLoad(const mimeType, pluginUrl,
      topOriginUrl: ustring; const pluginInfo: ICefWebPluginInfo;
  ...
  ICefRequestContext = interface(ICefBase)
    ...
    function GetDefaultCookieManager(const callback: ICefCompletionCallback)
      : ICefCookieManager;
    function GetDefaultCookieManagerProc(const callback
      : TCefCompletionCallbackProc): ICefCookieManager;
  ...
  protected
    procedure OnFileDialogDismissed(selectedAcceptFilter: Integer;
      filePaths: TStrings); override;
  public
    constructor create(callback: TCefRunFileDialogCallbackProc);
      reintroduce; virtual;
  end;
  ...
  protected
    ...
    function OnBeforeResourceLoad(const browser: ICefBrowser;
      const frame: ICefFrame; const request: ICefRequest;
      const callback: ICefRequestCallback): TCefReturnValue; virtual;
    function GetResourceHandler(const browser: ICefBrowser;
      const frame: ICefFrame; const request: ICefRequest)
    ...
    function OnResourceResponse(const browser: ICefBrowser;
      const frame: ICefFrame; const request: ICefRequest;
      const response: ICefResponse): Boolean; virtual;
    function GetAuthCredentials(const browser: ICefBrowser;
      const frame: ICefFrame; isProxy: Boolean; const host: ustring;
      port: Integer; const realm, scheme: ustring;
    ...
    function GetCookieManager(const browser: ICefBrowser;
  ...
  protected
    ...
    procedure OnFaviconUrlChange(const browser: ICefBrowser;
      iconUrls: TStrings); virtual;
    procedure OnFullScreenModeChange(const browser: ICefBrowser;
      fullscreen: Boolean); virtual;
...
{$ENDIF}
  ...
  TGetDataResourceForScale = {$IFDEF DELPHI12_UP}reference to
  {$ENDIF} function(resourceId: Integer; scaleFactor: TCefScaleFactor;
  ...
  public
    constructor create(const callback: TCefDeleteCookiesCallbackProc);
      reintroduce;
  end;
  ...
  public
    ...
    class function Global(const callback: ICefCompletionCallback)
      : ICefCookieManager;
    class function GlobalProc(const callback: TCefCompletionCallbackProc)
      : ICefCookieManager;
  ...
  {$ENDIF} function(const info: ICefWebPluginInfo;
    count, total: Integer): Boolean;
  ...
  protected
    function OnDragEnter(const browser: ICefBrowser;
      const dragData: ICefDragData; mask: TCefDragOperations): Boolean; virtual;
    procedure OnDraggableRegionsChanged(const browser: ICefBrowser;
  ...
  protected
    ...
    function OnBeforePluginLoad(const mimeType, pluginUrl,
      topOriginUrl: ustring; const pluginInfo: ICefWebPluginInfo;
      pluginPolicy: PCefPluginPolicy): Boolean; virtual;
  public
    constructor create; virtual;
  end;
...
function CefLoadLib(const Cache: ustring = ''; const UserDataPath: ustring = '';
  ...
  const AcceptLanguageList: ustring = ''; WindowsSandboxInfo: Pointer = nil;
...
function CefRemoveCrossOriginWhitelistEntry(const SourceOrigin, TargetProtocol,
  TargetDomain: ustring; AllowTargetSubdomains: Boolean): Boolean;
...
procedure CefPostDelayedTask(threadId: TCefThreadId; const task: ICefTask;
  delayMs: Int64);
...
procedure CefGetExtensionsForMimeType(const mimeType: ustring;
...
function CefParseCssColor(const str: ustring; strict: Boolean;
  out color: TCefColor): Boolean;
{$IFDEF Win32}
function CefParseJson(const jsonString: ustring; options: TCefJsonParserOptions)
  : ICefValue;
...
function CefWriteJson(const node: ICefValue;
...
function CefBeginTracing(const categories: ustring;
  const callback: ICefCompletionCallback): Boolean;
function CefEndTracing(const tracingFile: ustring;
...
var
  CefLibrary: string =
  {$IFDEF MSWINDOWS}'libcef.dll'{$ELSE}'libcef.dylib'{$ENDIF};
  CefCache: ustring = '';
...
var
  ...
  // The resulting string must be freed by calling cef_string_userfree_free().
  cef_base64encode: function(const data: Pointer; data_size: NativeUInt)
    : PCefStringUserFree;
{$IFDEF CPUX64}stdcall{$ELSE}cdecl{$ENDIF};
...
{$IFDEF CPUX64}stdcall{$ELSE}cdecl{$ENDIF};
  ...
  // The resulting string must be freed by calling cef_string_userfree_free().
  cef_uriencode: function(const text: PCefString; use_plus: Integer)
    : PCefStringUserFree;
{$IFDEF CPUX64}stdcall{$ELSE}cdecl{$ENDIF};
...
{$IFDEF Win32}
  ...
  cef_parse_json: function(const json_string: PCefString;
    options: TCefJsonParserOptions): PCefValue;
{$IFDEF CPUX64}stdcall{$ELSE}cdecl{$ENDIF};
  ...
  cef_parse_jsonand_return_error: function(const json_string: PCefString;
    options: TCefJsonParserOptions; error_code_out: PCefJsonParserError;
    error_msg_out: PCefString): PCefValue;
{$IFDEF CPUX64}stdcall{$ELSE}cdecl{$ENDIF};
  ...
  // The resulting string must be freed by calling cef_string_userfree_free().
  cef_write_json: function(node: PCefValue; options: TCefJsonWriterOptions)
    : PCefStringUserFree;
{$IFDEF CPUX64}stdcall{$ELSE}cdecl{$ENDIF};
{$ENDIF}
  // ******************************************************************************
  ...
  cef_cookie_manager_get_global_manager
    : function(callback: PCefCompletionCallback): PCefCookieManager;
  {$IFDEF CPUX64}stdcall{$ELSE}cdecl{$ENDIF};
  ...
  cef_cookie_manager_create_manager: function(const path: PCefString;
    persist_session_cookies: Integer; callback: PCefCompletionCallback)
    : PCefCookieManager; {$IFDEF CPUX64}stdcall{$ELSE}cdecl{$ENDIF};
  ...
  cef_urlrequest_create: function(request: PCefRequest;
    client: PCefUrlRequestClient; request_context: PCefRequestContext)
    : PCefUrlRequest; {$IFDEF CPUX64}stdcall{$ELSE}cdecl{$ENDIF};
...
{$IFDEF CPUX64}stdcall{$ELSE}cdecl{$ENDIF};
  ...
  cef_request_context_create_context
    : function(const settings: PCefRequestContextSettings;
...
begin
  if LibHandle = 0 then
    Result := CefLoadLib(CefCache, CefUserDataPath, CefUserAgent,
      CefProductVersion, CefLocale, CefLogFile, CefBrowserSubprocessPath,
      CefLogSeverity, CefJavaScriptFlags, CefResourcesDirPath,
      CefLocalesDirPath, CefSingleProcess, CefNoSandbox,
      CefCommandLineArgsDisabled, CefPackLoadingDisabled,
      CefRemoteDebuggingPort, CefUncaughtExceptionStackSize,
      CefContextSafetyImplementation, CefPersistSessionCookies,
      CefIgnoreCertificateErrors, CefBackgroundColor, CefAcceptLanguageList,
      CefWindowsSandboxInfo, CefWindowlessRenderingEnabled)
  else
    Result := True;
end;

function CefLoadLib(const Cache, UserDataPath, UserAgent, ProductVersion,
  locale, LogFile, BrowserSubprocessPath: ustring; LogSeverity: TCefLogSeverity;
  ...
  : Boolean; RemoteDebuggingPort: Integer; UncaughtExceptionStackSize: Integer;
  ContextSafetyImplementation: Integer; persistSessionCookies: Boolean;
  IgnoreCertificateErrors: Boolean; BackgroundColor: TCefColor;
  const AcceptLanguageList: ustring; WindowsSandboxInfo: Pointer;
...
begin
  ...
  begin
    ...
    cef_string_utf16_clear := GetProcAddress(LibHandle,
    ...
    cef_string_utf8_to_wide := GetProcAddress(LibHandle,
      'cef_string_utf8_to_wide');
    cef_string_wide_to_utf16 := GetProcAddress(LibHandle,
      'cef_string_wide_to_utf16');
    cef_string_utf16_to_wide := GetProcAddress(LibHandle,
      'cef_string_utf16_to_wide');
    cef_string_utf8_to_utf16 := GetProcAddress(LibHandle,
      'cef_string_utf8_to_utf16');
    cef_string_utf16_to_utf8 := GetProcAddress(LibHandle,
      'cef_string_utf16_to_utf8');
    cef_string_ascii_to_wide := GetProcAddress(LibHandle,
      'cef_string_ascii_to_wide');
    cef_string_ascii_to_utf16 := GetProcAddress(LibHandle,
      'cef_string_ascii_to_utf16');
    cef_string_userfree_wide_alloc := GetProcAddress(LibHandle,
      'cef_string_userfree_wide_alloc');
    cef_string_userfree_utf8_alloc := GetProcAddress(LibHandle,
      'cef_string_userfree_utf8_alloc');
    cef_string_userfree_utf16_alloc := GetProcAddress(LibHandle,
      'cef_string_userfree_utf16_alloc');
    cef_string_userfree_wide_free := GetProcAddress(LibHandle,
      'cef_string_userfree_wide_free');
    cef_string_userfree_utf8_free := GetProcAddress(LibHandle,
...
{$ENDIF}
    ...
    cef_do_message_loop_work := GetProcAddress(LibHandle,
    ...
    cef_enable_highdpi_support := GetProcAddress(LibHandle,
      'cef_enable_highdpi_support');
    cef_register_extension := GetProcAddress(LibHandle,
      'cef_register_extension');
    cef_register_scheme_handler_factory := GetProcAddress(LibHandle,
      'cef_register_scheme_handler_factory');
    cef_clear_scheme_handler_factories := GetProcAddress(LibHandle,
      'cef_clear_scheme_handler_factories');
    cef_add_cross_origin_whitelist_entry := GetProcAddress(LibHandle,
      'cef_add_cross_origin_whitelist_entry');
    cef_remove_cross_origin_whitelist_entry :=
      GetProcAddress(LibHandle, 'cef_remove_cross_origin_whitelist_entry');
    cef_clear_cross_origin_whitelist := GetProcAddress(LibHandle,
    ...
    cef_get_extensions_for_mime_type := GetProcAddress(LibHandle,
...
{$IFDEF Win32}
    ...
    cef_parse_jsonand_return_error := GetProcAddress(LibHandle,
      'cef_parse_jsonand_return_error');
    cef_write_json := GetProcAddress(LibHandle, 'cef_write_json');
{$ENDIF}
    cef_browser_host_create_browser := GetProcAddress(LibHandle,
      'cef_browser_host_create_browser');
    cef_browser_host_create_browser_sync := GetProcAddress(LibHandle,
      'cef_browser_host_create_browser_sync');
    ...
    cef_post_data_element_create := GetProcAddress(LibHandle,
      'cef_post_data_element_create');
    cef_stream_reader_create_for_file := GetProcAddress(LibHandle,
      'cef_stream_reader_create_for_file');
    cef_stream_reader_create_for_data := GetProcAddress(LibHandle,
      'cef_stream_reader_create_for_data');
    cef_stream_reader_create_for_handler := GetProcAddress(LibHandle,
      'cef_stream_reader_create_for_handler');
    cef_stream_writer_create_for_file := GetProcAddress(LibHandle,
      'cef_stream_writer_create_for_file');
    cef_stream_writer_create_for_handler := GetProcAddress(LibHandle,
      'cef_stream_writer_create_for_handler');
    cef_v8context_get_current_context := GetProcAddress(LibHandle,
      'cef_v8context_get_current_context');
    cef_v8context_get_entered_context := GetProcAddress(LibHandle,
      'cef_v8context_get_entered_context');
    cef_v8context_in_context := GetProcAddress(LibHandle,
      'cef_v8context_in_context');
    cef_v8value_create_undefined := GetProcAddress(LibHandle,
      'cef_v8value_create_undefined');
    cef_v8value_create_null := GetProcAddress(LibHandle,
      'cef_v8value_create_null');
    cef_v8value_create_bool := GetProcAddress(LibHandle,
      'cef_v8value_create_bool');
    cef_v8value_create_int := GetProcAddress(LibHandle,
      'cef_v8value_create_int');
    cef_v8value_create_uint := GetProcAddress(LibHandle,
      'cef_v8value_create_uint');
    cef_v8value_create_double := GetProcAddress(LibHandle,
      'cef_v8value_create_double');
    cef_v8value_create_date := GetProcAddress(LibHandle,
      'cef_v8value_create_date');
    cef_v8value_create_string := GetProcAddress(LibHandle,
      'cef_v8value_create_string');
    cef_v8value_create_object := GetProcAddress(LibHandle,
      'cef_v8value_create_object');
    cef_v8value_create_array := GetProcAddress(LibHandle,
      'cef_v8value_create_array');
    cef_v8value_create_function := GetProcAddress(LibHandle,
      'cef_v8value_create_function');
    cef_v8stack_trace_get_current := GetProcAddress(LibHandle,
    ...
    cef_string_multimap_alloc := GetProcAddress(LibHandle,
      'cef_string_multimap_alloc');
    cef_string_multimap_size := GetProcAddress(LibHandle,
      'cef_string_multimap_size');
    cef_string_multimap_find_count := GetProcAddress(LibHandle,
      'cef_string_multimap_find_count');
    cef_string_multimap_enumerate := GetProcAddress(LibHandle,
      'cef_string_multimap_enumerate');
    cef_string_multimap_key := GetProcAddress(LibHandle,
      'cef_string_multimap_key');
    cef_string_multimap_value := GetProcAddress(LibHandle,
      'cef_string_multimap_value');
    cef_string_multimap_append := GetProcAddress(LibHandle,
      'cef_string_multimap_append');
    cef_string_multimap_clear := GetProcAddress(LibHandle,
      'cef_string_multimap_clear');
    cef_string_multimap_free := GetProcAddress(LibHandle,
      'cef_string_multimap_free');

    cef_cookie_manager_get_global_manager :=
      GetProcAddress(LibHandle, 'cef_cookie_manager_get_global_manager');
    cef_cookie_manager_create_manager := GetProcAddress(LibHandle,
      'cef_cookie_manager_create_manager');

    cef_command_line_create := GetProcAddress(LibHandle,
      'cef_command_line_create');

    cef_command_line_get_global := GetProcAddress(LibHandle,
      'cef_command_line_get_global');

    cef_process_message_create := GetProcAddress(LibHandle,
      'cef_process_message_create');

    cef_value_create := GetProcAddress(LibHandle, 'cef_value_create');

    cef_binary_value_create := GetProcAddress(LibHandle,
    ...
    cef_visit_web_plugin_info := GetProcAddress(LibHandle,
      'cef_visit_web_plugin_info');
    cef_refresh_web_plugins := GetProcAddress(LibHandle,
      'cef_refresh_web_plugins');
    cef_add_web_plugin_path := GetProcAddress(LibHandle,
      'cef_add_web_plugin_path');
    cef_add_web_plugin_directory := GetProcAddress(LibHandle,
      'cef_add_web_plugin_directory');
    cef_remove_web_plugin_path := GetProcAddress(LibHandle,
      'cef_remove_web_plugin_path');
    cef_unregister_internal_web_plugin := GetProcAddress(LibHandle,
      'cef_unregister_internal_web_plugin');
    cef_force_web_plugin_shutdown := GetProcAddress(LibHandle,
      'cef_force_web_plugin_shutdown');
    cef_register_web_plugin_crash := GetProcAddress(LibHandle,
      'cef_register_web_plugin_crash');
    cef_is_web_plugin_unstable := GetProcAddress(LibHandle,
    ...
    cef_task_runner_get_for_current_thread :=
      GetProcAddress(LibHandle, 'cef_task_runner_get_for_current_thread');
    ...
    cef_now_from_system_trace_time := GetProcAddress(LibHandle,
      'cef_now_from_system_trace_time');

    cef_request_context_get_global_context :=
      GetProcAddress(LibHandle, 'cef_request_context_get_global_context');
    cef_request_context_create_context := GetProcAddress(LibHandle,
      'cef_request_context_create_context');
    ...
    cef_get_current_platform_thread_id := GetProcAddress(LibHandle,
      'cef_get_current_platform_thread_id');
    cef_get_current_platform_thread_handle :=
      GetProcAddress(LibHandle, 'cef_get_current_platform_thread_handle');

    cef_trace_event_instant := GetProcAddress(LibHandle,
    ...
    cef_trace_event_async_begin := GetProcAddress(LibHandle,
      'cef_trace_event_async_begin');
    cef_trace_event_async_step_into := GetProcAddress(LibHandle,
      'cef_trace_event_async_step_into');
    cef_trace_event_async_step_past := GetProcAddress(LibHandle,
      'cef_trace_event_async_step_past');
    cef_trace_event_async_end := GetProcAddress(LibHandle,
      'cef_trace_event_async_end');

    cef_print_settings_create := GetProcAddress(LibHandle,
      'cef_print_settings_create');

    cef_drag_data_create := GetProcAddress(LibHandle, 'cef_drag_data_create');

    cef_resource_bundle_get_global := GetProcAddress(LibHandle,
    ...
    if not(
      ...
      Assigned(cef_enable_highdpi_support) and Assigned(cef_register_extension)
      and Assigned(cef_register_scheme_handler_factory) and
      ...
      and Assigned(cef_base64encode) and Assigned(cef_base64decode) and
      Assigned(cef_uriencode) and Assigned(cef_uridecode) and
      Assigned(cef_parse_csscolor) and
{$IFDEF Win32}
      Assigned(cef_parse_json) and Assigned(cef_parse_jsonand_return_error) and
...
{$ENDIF}
      ...
      and Assigned(cef_cookie_manager_get_global_manager) and
      ...
      Assigned(cef_process_message_create) and Assigned(cef_value_create) and
      Assigned(cef_binary_value_create) and
      Assigned(cef_dictionary_value_create) and Assigned(cef_list_value_create)
      and Assigned(cef_get_path) and Assigned(cef_launch_process) and
      Assigned(cef_response_create) and Assigned(cef_urlrequest_create) and
      Assigned(cef_visit_web_plugin_info) and Assigned(cef_refresh_web_plugins)
      and Assigned(cef_add_web_plugin_path) and
      ...
      Assigned(create_context_shared) and Assigned(cef_get_min_log_level) and
      Assigned(cef_get_vlog_level) and Assigned(cef_log) and
      ...
      Assigned(cef_print_settings_create) and Assigned(cef_drag_data_create) and
      Assigned(cef_resource_bundle_get_global)) then
...
function CefGetObject(ptr: Pointer): TObject; {$IFDEF SUPPORTS_INLINE} inline;
{$ENDIF}
begin
...
begin
  s := CefString(text);
  Result := CefStringFreeAndGet(cef_uridecode(@s, ord(convertToUtf8),
    unescapeRule));
end;
...
begin
  ...
  Result := TCefBrowserRef.UnWrap(cef_browser_host_create_browser_sync
    (windowInfo, CefGetData(client), @u, settings, CefGetData(RequestContext)));
end;
...
function cef_client_get_find_handler(self: PCefClient)
  : PCefFindHandler; stdcall;
begin
  with TCefClientOwn(CefGetObject(self)) do
...
begin
  ...
  with TCefLifeSpanHandlerOwn(CefGetObject(self)) do
    Result := ord(OnBeforePopup(TCefBrowserRef.UnWrap(browser),
      TCefFrameRef.UnWrap(frame), _url, _frame, target_disposition,
      user_gesture <> 0, popupFeatures^, windowInfo^, _client,
      settings^, _nojs));
...
function cef_life_span_handler_run_modal(self: PCefLifeSpanHandler;
...
begin
  with TCefRequestHandlerOwn(CefGetObject(self)) do
    Result := ord(OnBeforeBrowse(TCefBrowserRef.UnWrap(browser),
...
begin
  with TCefRequestHandlerOwn(CefGetObject(self)) do
    Result := ord(OnOpenUrlFromTab(TCefBrowserRef.UnWrap(browser),
      TCefFrameRef.UnWrap(frame), CefString(target_url), target_disposition,
      user_gesture <> 0));
end;
...
begin
  with TCefRequestHandlerOwn(CefGetObject(self)) do
    Result := OnBeforeResourceLoad(TCefBrowserRef.UnWrap(browser),
      TCefFrameRef.UnWrap(frame), TCefRequestRef.UnWrap(request),
...
begin
  ...
  with TCefRequestHandlerOwn(CefGetObject(self)) do
    OnResourceRedirect(TCefBrowserRef.UnWrap(browser),
      TCefFrameRef.UnWrap(frame), TCefRequestRef.UnWrap(request), url);
  if url <> '' then
...
begin
  with TCefRequestHandlerOwn(CefGetObject(self)) do
    Result := ord(OnResourceResponse(TCefBrowserRef.UnWrap(browser),
      TCefFrameRef.UnWrap(frame), TCefRequestRef.UnWrap(request),
...
begin
  with TCefRequestHandlerOwn(CefGetObject(self)) do
    Result := ord(GetAuthCredentials(TCefBrowserRef.UnWrap(browser),
      TCefFrameRef.UnWrap(frame), isProxy <> 0, CefString(host), port,
      CefString(realm), CefString(scheme),
      TCefAuthCallbackRef.UnWrap(callback)));
end;

function cef_request_handler_on_quota_request(self: PCefRequestHandler;
  browser: PCefBrowser; const origin_url: PCefString; new_size: Int64;
  callback: PCefRequestCallback): Integer; stdcall;
begin
  with TCefRequestHandlerOwn(CefGetObject(self)) do
    Result := ord(OnQuotaRequest(TCefBrowserRef.UnWrap(browser),
      CefString(origin_url), new_size,
      TCefRequestCallbackRef.UnWrap(callback)));
end;
...
procedure cef_request_handler_on_render_process_terminated
...
procedure cef_display_handler_on_fullscreen_mode_change
...
begin
  ...
  with TCefJsDialogHandlerOwn(CefGetObject(self)) do
    Result := ord(OnJsdialog(TCefBrowserRef.UnWrap(browser),
      CefString(origin_url), CefString(accept_lang), dialog_type,
...
begin
  with TCefJsDialogHandlerOwn(CefGetObject(self)) do
    Result := ord(OnBeforeUnloadDialog(TCefBrowserRef.UnWrap(browser),
      CefString(message_text), is_reload <> 0,
...
begin
  with TCefContextMenuHandlerOwn(CefGetObject(self)) do
    Result := ord(RunContextMenu(TCefBrowserRef.UnWrap(browser),
      TCefFrameRef.UnWrap(frame), TCefContextMenuParamsRef.UnWrap(params),
      TCefMenuModelRef.UnWrap(model), TCefRunContextMenuCallbackRef.UnWrap
      (callback)));
end;
...
begin
  ...
  Result := -ord(TCefv8HandlerOwn(CefGetObject(self)).execute(CefString(name),
    TCefv8ValueRef.UnWrap(obj), args, ret, exc));
...
procedure cef_download_handler_on_download_updated(self: PCefDownloadHandler;
  ...
  callback: PCefDownloadItemCallback); stdcall;
begin
  TCefDownloadHandlerOwn(CefGetObject(self)).OnDownloadUpdated
    (TCefBrowserRef.UnWrap(browser), TCefDownLoadItemRef.UnWrap(download_item),
...
begin
  TCefDomVisitorOwn(CefGetObject(self))
...
begin
  ...
  if cookie.has_expires <> 0 then
    ...
    exp := 0;
  Result := ord(TCefCookieVisitorOwn(CefGetObject(self))
    .visit(CefString(@cookie.name), CefString(@cookie.value),
    CefString(@cookie.domain), CefString(@cookie.path), Boolean(cookie.secure),
    Boolean(cookie.httponly), Boolean(cookie.has_expires),
    CefTimeToDateTime(cookie.creation), CefTimeToDateTime(cookie.last_access),
    exp, count, total, delete));
...
function cef_resource_bundle_handler_get_data_resource_for_scale
  (self: PCefResourceBundleHandler; resource_id: Integer;
  scale_factor: TCefScaleFactor; out data: Pointer; data_size: NativeUInt)
  : Integer; stdcall;
begin
  Result := ord(TCefResourceBundleHandlerOwn(CefGetObject(self))
...
function cef_app_get_resource_bundle_handler(self: PCefApp)
  : PCefResourceBundleHandler; stdcall;
begin
  Result := CefGetData(TCefAppOwn(CefGetObject(self))
...
begin
  ...
  with TCefSchemeHandlerFactoryOwn(CefGetObject(self)) do
    Result := CefGetData(New(TCefBrowserRef.UnWrap(browser),
      TCefFrameRef.UnWrap(frame), CefString(scheme_name),
...
function cef_dialog_handler_on_file_dialog(self: PCefDialogHandler;
  browser: PCefBrowser; mode: TCefFileDialogMode;
  const title, default_file_path: PCefString; accept_filters: TCefStringList;
  selected_accept_filter: Integer; callback: PCefFileDialogCallback)
  : Integer; stdcall;
var
  list: TStringList;
  i: Integer;
...
begin
  ...
  try
    ...
    with TCefDialogHandlerOwn(CefGetObject(self)) do
      Result := ord(OnFileDialog(TCefBrowserRef.UnWrap(browser), mode,
        CefString(title), CefString(default_file_path), list,
        selected_accept_filter, TCefFileDialogCallbackRef.UnWrap(callback)));
  finally
    list.Free;
  end;
end;
...
procedure cef_render_handler_on_scroll_offset_changed
  (self: PCefRenderProcessHandler; browser: PCefBrowser; x, y: Double); stdcall;
begin
  with TCefRenderHandlerOwn(CefGetObject(self)) do
...
begin
  with TCefDragHandlerOwn(CefGetObject(self)) do
    OnDraggableRegionsChanged(TCefBrowserRef.UnWrap(browser),
...
procedure cef_find_handler_on_find_result(self: PCefFindHandler;
  ...
  const selection_rect: PCefRect; active_match_ordinal,
  final_update: Integer); stdcall;
begin
  with TCefFindHandlerOwn(CefGetObject(self)) do
    OnFindResult(TCefBrowserRef.UnWrap(browser), identifier, count,
      selection_rect, active_match_ordinal, final_update <> 0);
end;
...
function cef_request_context_handler_on_before_plugin_load
  (self: PCefRequestContextHandler; const mime_type, plugin_url,
  top_origin_url: PCefString; plugin_info: PCefWebPluginInfo;
  plugin_policy: PCefPluginPolicy): Integer; stdcall;
begin
  with TCefRequestContextHandlerOwn(CefGetObject(self)) do
    Result := ord(OnBeforePluginLoad(CefString(mime_type),
      CefString(plugin_url), CefString(top_origin_url),
      TCefWebPluginInfoRef.UnWrap(plugin_info), plugin_policy));
end;
...
procedure cef_delete_cookie_callback_on_complete
  (self: PCefDeleteCookiesCallback; num_deleted: Integer); stdcall;
begin
...
procedure cef_pdf_print_callback_on_pdf_print_finished
  (self: PCefPdfPrintCallback; const path: PCefString; ok: Integer); stdcall;
begin
...
begin
  Result := PCefBrowser(FData)^.send_process_message(PCefBrowser(FData),
    targetProcess, CefGetData(message)) <> 0;
end;
...
begin
  Result := CefStringFreeAndGet(PCefPostDataElement(FData)
...
begin
  u := CefString(url);
  m := CefString(method);
  PCefRequest(FData).set_(PCefRequest(FData), @u, @m, CefGetData(postData),
    headerMap.Handle);
end;

function TCefRequestRef.GetFirstPartyForCookies: ustring;
begin
  Result := CefStringFreeAndGet(PCefRequest(FData).get_first_party_for_cookies
    (PCefRequest(FData)));
end;
...
begin
  Result := CefStringFreeAndGet(PCefRequest(FData)
...
begin
  ...
  try
    ...
    Result := TCefv8ValueRef.UnWrap(PCefv8Value(FData)
      ^.execute_function(PCefv8Value(FData), CefGetData(obj),
...
begin
  ...
  try
    for i := 0 to length(arguments) - 1 do
      args[i] := CefGetData(arguments[i]);
    Result := TCefv8ValueRef.UnWrap(PCefv8Value(FData)
      ^.execute_function_with_context(PCefv8Value(FData), CefGetData(context),
...
begin
  Result := CefTimeToDateTime(PCefv8Value(FData)
...
begin
  Result := CefStringFreeAndGet(PCefv8Value(FData)
...
begin
  Result := CefStringFreeAndGet(PCefXmlReader(FData).get_attribute_byindex
    (FData, index));
end;
...
begin
  ...
  Result := CefStringFreeAndGet(PCefXmlReader(FData).get_attribute_bylname
    (FData, @l, @n));
end;
...
begin
  ...
  Result := CefStringFreeAndGet(PCefXmlReader(FData).get_attribute_byqname
    (FData, @q));
end;
...
begin
  Result := CefStringFreeAndGet(PCefDomDocument(FData)
...
begin
  Result := CefStringFreeAndGet(PCefDomDocument(FData)^.get_selection_as_markup
    (PCefDomDocument(FData)));
end;

function TCefDomDocumentRef.GetSelectionAsText: ustring;
begin
  Result := CefStringFreeAndGet(PCefDomDocument(FData)^.get_selection_as_text
    (PCefDomDocument(FData)));
end;
...
begin
  Result := CefStringFreeAndGet(PCefDomNode(FData)
...
begin
  ...
  Result := CefStringFreeAndGet(PCefDomNode(FData)^.get_element_attribute
    (PCefDomNode(FData), @p));
end;
...
begin
  Result := CefStringFreeAndGet(PCefDomNode(FData)^.get_element_inner_text
    (PCefDomNode(FData)));
end;

function TCefDomNodeRef.GetElementTagName: ustring;
begin
  Result := CefStringFreeAndGet(PCefDomNode(FData)^.get_element_tag_name
    (PCefDomNode(FData)));
end;
...
begin
  n := CefString(name);
  Result := CefStringFreeAndGet(PCefResponse(FData)
...
begin
  pd := GetTypeData(pi);
  if (v.IsInt or v.IsBool) and (v.GetIntValue >= pd.MinValue) and
...
begin
  try
    CefLastCallJavaScriptMethodTicket := GetTickCount;
    Result := True;
    p := PChar(name);
    m := nil;
    if obj <> nil then
...
{$ENDIF}
                        ...
                        's':
                          begin
                            Inc(p);
                            pr := rt.GetProperty(p);
                            if GetValue(pr.PropertyType.Handle,
                              arguments[0], ret) then
                            begin
{$IFDEF CEF_MULTI_THREADED_MESSAGE_LOOP}
                              if FSyncMainThread then
                              begin
...
{$ENDIF}
                begin
                  // outputDebugString(PWideChar(Format('GetCurrentThreadID:%d, MainThreadID:%d', [GetCurrentThreadID(), MainThreadID])));
                  if CefIsMainProcess then
                  begin
                    if m.MethodKind = mkClassProcedure then
                    begin
                      // MessageBox(0, PChar(name + #$D#$A + Format('GetCurrentThreadID:%d, MainThreadID:%d', [GetCurrentThreadID(), MainThreadID])), 'mkClassProcedure', 0);
                      try
                        if CefExternalMode then
                          m.Invoke(cls, args)
                        else
                    ...
                    begin
                      // MessageBox(0, PChar(name + #$D#$A + Format('GetCurrentThreadID:%d, MainThreadID:%d', [GetCurrentThreadID(), MainThreadID])), 'mkClassFunction', 0);
                      try
                        if CefExternalMode then
                          ret := m.Invoke(cls, args)
                        else
            ...
            mkProcedure, mkFunction:
              begin
                // MessageBox(0, PChar(name), 'mkProcedure, mkFunction', 0);
                if (val <> nil) then
                begin
{$IFDEF CEF_MULTI_THREADED_MESSAGE_LOOP}
                  if FSyncMainThread then
...
begin
  ...
  begin
    ...
    on_render_process_terminated :=
      cef_request_handler_on_render_process_terminated;
  end;
end;
...
procedure TCefDisplayHandlerOwn.OnFullScreenModeChange(const browser
  : ICefBrowser; fullscreen: Boolean);
begin
...
begin
  Result := CefStringFreeAndGet(PCefV8Exception(FData)
...
begin
  ...
  begin
    ...
    get_data_resource_for_scale :=
      cef_resource_bundle_handler_get_data_resource_for_scale;
  end;
end;
...
AGetLocalizedString: TGetLocalizedString;
AGetDataResourceForScale: TGetDataResourceForScale);
begin
  inherited create;
...
begin
  if Assigned(FGetDataResource) then
    Result := FGetDataResource(resourceId, data, dataSize)
  else
    Result := False;
end;

function TCefFastResourceBundle.GetDataResourceForScale(resourceId: Integer;
scaleFactor: TCefScaleFactor; out data: Pointer; dataSize: NativeUInt): Boolean;
begin
...
begin
  if Assigned(FGetLocalizedString) then
    Result := FGetLocalizedString(stringId, stringVal)
  else
    Result := False;
end;
...
persistSessionCookies: Boolean; const callback: ICefCompletionCallback)
  : ICefCookieManager;
var
  pth: TCefString;
begin
  ...
  Result := UnWrap(cef_cookie_manager_create_manager(@pth,
    ord(persistSessionCookies), CefGetData(callback)));
end;

class function TCefCookieManagerRef.NewProc(const path: ustring;
persistSessionCookies: Boolean; const callback: TCefCompletionCallbackProc)
  : ICefCookieManager;
begin
  Result := New(path, persistSessionCookies,
    TCefFastCompletionCallback.create(callback));
end;
...
begin
  ...
  Result := PCefCookieManager(FData).delete_cookies(PCefCookieManager(FData),
    @u, @n, CefGetData(callback)) <> 0;
end;

function TCefCookieManagerRef.DeleteCookiesProc(const url, cookieName: ustring;
const callback: TCefDeleteCookiesCallbackProc): Boolean;
begin
  Result := DeleteCookies(url, cookieName,
    TCefFastDeleteCookiesCallback.create(callback));
end;

function TCefCookieManagerRef.FlushStore(const handler
  : ICefCompletionCallback): Boolean;
begin
  Result := PCefCookieManager(FData).flush_store(PCefCookieManager(FData),
    CefGetData(handler)) <> 0;
end;

function TCefCookieManagerRef.FlushStoreProc(const proc
  : TCefCompletionCallbackProc): Boolean;
begin
  Result := FlushStore(TCefFastCompletionCallback.create(proc))
end;

class function TCefCookieManagerRef.Global(const callback
  : ICefCompletionCallback): ICefCookieManager;
begin
  Result := UnWrap(cef_cookie_manager_get_global_manager(CefGetData(callback)));
end;

class function TCefCookieManagerRef.GlobalProc(const callback
  : TCefCompletionCallbackProc): ICefCookieManager;
begin
...
begin
  ...
  Result := PCefCookieManager(FData).set_cookie(PCefCookieManager(FData), @str,
    @cook, CefGetData(callback)) <> 0;
end;
...
begin
  Result := SetCookie(url, name, value, domain, path, secure, httponly,
    hasExpires, creation, lastAccess, expires,
...
begin
  p := CefString(path);
  Result := PCefCookieManager(FData)^.set_storage_path(PCefCookieManager(FData),
    @p, ord(persistSessionCookies), CefGetData(callback)) <> 0;
end;
...
const callback: TCefCompletionCallbackProc): Boolean;
begin
  Result := SetStoragePath(path, persistSessionCookies,
    TCefFastCompletionCallback.create(callback));
end;
...
begin
  ...
  Result := PCefCookieManager(FData).visit_url_cookies(PCefCookieManager(FData),
    @str, ord(includeHttpOnly), CefGetData(visitor)) <> 0;
end;
...
begin
  Result := CefStringFreeAndGet(PCefWebPluginInfo(FData)
...
const event: PCefMouseEvent; allowedOps: TCefDragOperations);
begin
  PCefBrowserHost(FData).drag_target_drag_enter(FData, CefGetData(dragData),
    event, allowedOps);
end;
...
begin
  str := CefString(path);
  PCefBrowserHost(FData).print_to_pdf(FData, @str, settings,
    CefGetData(callback));
end;
...
begin
  RunFileDialog(mode, title, defaultFilePath, acceptFilters,
    selectedAcceptFilter, TCefFastRunFileDialogCallback.create(callback));
end;
...
begin
  PCefBrowserHost(FData).set_windowless_frame_rate(PCefBrowserHost(FData),
    frameRate);
end;

procedure TCefBrowserHostRef.SetWindowVisibility(visible: Boolean);
begin
  PCefBrowserHost(FData).set_window_visibility(PCefBrowserHost(FData),
    ord(visible));
end;
...
begin
  Result := PCefBrowserHost(FData).get_windowless_frame_rate
...
begin
  PCefBrowserHost(FData).get_navigation_entries(FData, CefGetData(visitor),
    ord(currentOnly));
end;
...
begin
  Result := CefStringFreeAndGet(PCefProcessMessage(FData)
...
begin
  Result := CefStringFreeAndGet(PCefDownloadItem(FData)^.get_content_disposition
...
begin
  Result := CefTimeToDateTime(PCefDownloadItem(FData)
    ^.get_end_time(PCefDownloadItem(FData)));
end;

function TCefDownLoadItemRef.GetFullPath: ustring;
begin
  Result := CefStringFreeAndGet(PCefDownloadItem(FData)
...
begin
  Result := CefStringFreeAndGet(PCefDownloadItem(FData)
    ^.get_original_url(PCefDownloadItem(FData)));
end;
...
begin
  Result := CefStringFreeAndGet(PCefDownloadItem(FData)^.get_suggested_file_name
    (PCefDownloadItem(FData)));
end;
...
begin
  Result := CefStringFreeAndGet(PCefCommandLine(FData).get_command_line_string
    (PCefCommandLine(FData)));
end;

function TCefCommandLineRef.GetProgram: ustring;
begin
  Result := CefStringFreeAndGet(PCefCommandLine(FData)
...
begin
  Result := CefStringFreeAndGet(PCefContextMenuParams(FData)
...
begin
  Result := PCefContextMenuParams(FData)
    .is_custom_menu(PCefContextMenuParams(FData)) <> 0;
end;
...
begin
  Result := PCefContextMenuParams(FData)
    .is_pepper_menu(PCefContextMenuParams(FData)) <> 0;
end;
...
begin
  Result := CefStringFreeAndGet(PCefMenuModel(FData)
...
begin
  Result := CefStringFreeAndGet(PCefListValue(FData)
...
begin
  Result := TCefValueRef.UnWrap(PCefListValue(FData)
    .get_value(PCefListValue(FData), index));
end;

function TCefListValueRef.IsEqual(const that: ICefListValue): Boolean;
begin
  Result := PCefListValue(FData).is_equal(PCefListValue(FData),
    CefGetData(that)) <> 0;
end;
...
begin
  Result := PCefListValue(FData).is_same(PCefListValue(FData),
    CefGetData(that)) <> 0;
end;
...
begin
  Result := PCefListValue(FData).set_value(PCefListValue(FData), index,
    CefGetData(value)) <> 0;
end;
...
begin
  Result := PCefBinaryValue(FData).is_equal(PCefBinaryValue(FData),
    CefGetData(that)) <> 0;
end;
...
begin
  Result := PCefBinaryValue(FData).is_same(PCefBinaryValue(FData),
    CefGetData(that)) <> 0;
end;
...
begin
  k := CefString(key);
  Result := CefStringFreeAndGet(PCefDictionaryValue(FData)
...
begin
  k := CefString(key);
  Result := TCefValueRef.UnWrap(PCefDictionaryValue(FData)
    .get_value(PCefDictionaryValue(FData), @k));
end;
...
function TCefDictionaryValueRef.IsEqual(const that
  : ICefDictionaryValue): Boolean;
begin
  Result := PCefDictionaryValue(FData).is_equal(PCefDictionaryValue(FData),
    CefGetData(that)) <> 0;
end;
...
function TCefDictionaryValueRef.IsSame(const that: ICefDictionaryValue)
  : Boolean;
begin
  Result := PCefDictionaryValue(FData).is_same(PCefDictionaryValue(FData),
    CefGetData(that)) <> 0;
end;
...
begin
  k := CefString(key);
  Result := PCefDictionaryValue(FData)
    .set_dictionary(PCefDictionaryValue(FData), @k, CefGetData(value)) <> 0;
end;
...
begin
  k := CefString(key);
  Result := PCefDictionaryValue(FData).set_value(PCefDictionaryValue(FData), @k,
    CefGetData(value)) <> 0;
end;
...
const frame: ICefFrame; const schemeName: ustring; const request: ICefRequest)
  : ICefResourceHandler;
//var
//  AHeadMap: ICefStringMultiMap;
//begin
//  AHeadMap := TCefStringMultiMapOwn.Create;
//  request.GetHeaderMap(AHeadMap);
//  AHeadMap.Append('Connection', 'keep-alive');
//  request.SetHeaderMap(AHeadMap);
begin
...
procedure TCefUrlrequestClientOwn.OnDownloadProgress(const request
  : ICefUrlRequest; current, total: Int64);
begin
...
const client: ICefUrlrequestClient; const RequestContext: ICefRequestContext)
  : ICefUrlRequest;
begin
  Result := UnWrap(cef_urlrequest_create(CefGetData(request),
    CefGetData(client), CefGetData(RequestContext)));
end;
...
class function TCefRequestCallbackRef.UnWrap(data: Pointer)
  : ICefRequestCallback;
begin
  if data <> nil then
...
begin
  Result := CefStringFreeAndGet(PCefV8StackFrame(FData)
...
begin
  ...
  with PCefRunFileDialogCallback(FData)^ do
    on_file_dialog_dismissed :=
      cef_run_file_dialog_callback_on_file_dialog_dismissed;
end;
...
begin
  Result := PCefTaskRunner(FData).post_delayed_task(FData, CefGetData(task),
    delayMs) <> 0;
end;
...
procedure TCefFileDialogCallbackRef.cont(selectedAcceptFilter: Integer;
filePaths: TStrings);
var
  list: TCefStringList;
  i: Integer;
...
begin
  Result := CefStringFreeAndGet(PCefDragData(FData)
...
procedure TCefDragHandlerOwn.OnDraggableRegionsChanged(const browser
  : ICefBrowser; regionsCount: NativeUInt; regions: PCefDraggableRegionArray);
begin
...
begin
  Result := CefStringFreeAndGet(PCefRequestContext(FData)
    .get_cache_path(FData));
end;

function TCefRequestContextRef.GetDefaultCookieManager(const callback
  : ICefCompletionCallback): ICefCookieManager;
begin
  Result := TCefCookieManagerRef.UnWrap(PCefRequestContext(FData)
    .get_default_cookie_manager(FData, CefGetData(callback)));
end;

function TCefRequestContextRef.GetDefaultCookieManagerProc(const callback
  : TCefCompletionCallbackProc): ICefCookieManager;
begin
  Result := GetDefaultCookieManager
    (TCefFastCompletionCallback.create(callback));
end;

function TCefRequestContextRef.GetHandler: ICefRequestContextHandler;
begin
  Result := TCefRequestContextHandlerRef.UnWrap(PCefRequestContext(FData)
    .get_handler(FData));
end;
...
function TCefRequestContextRef.IsSharingWith(const other
  : ICefRequestContext): Boolean;
begin
  Result := PCefRequestContext(FData).is_sharing_with(FData,
    CefGetData(other)) <> 0;
end;

class function TCefRequestContextRef.New(const settings
  : PCefRequestContextSettings; const handler: ICefRequestContextHandler)
  : ICefRequestContext;
begin
  Result := UnWrap(cef_request_context_create_context(settings,
    CefGetData(handler)));
end;
...
begin
  ...
  Result := PCefRequestContext(FData).register_scheme_handler_factory(FData, @s,
    @d, CefGetData(factory)) <> 0;
end;

class function TCefRequestContextRef.Shared(const other: ICefRequestContext;
const handler: ICefRequestContextHandler): ICefRequestContext;
begin
  Result := UnWrap(create_context_shared(CefGetData(other),
    CefGetData(handler)));
end;
...
begin
  ...
  Result := PCefRequestContextHandler(FData).on_before_plugin_load(FData, @mt,
    @pu, @ou, CefGetData(pluginInfo), pluginPolicy) <> 0;
end;
...
begin
  Result := CefStringFreeAndGet(PCefPrintSettings(FData)
...
begin
  Result := CefStringFreeAndGet(PCefNavigationEntry(FData)
...
begin
  Result := CefTimeToDateTime(PCefNavigationEntry(FData)
...
constructor TCefFastSetCookieCallback.create(const callback
...
constructor TCefFastDeleteCookiesCallback.create(const callback
...
begin
  Result := TCefDictionaryValueRef.UnWrap
    (PCefValue(FData).get_dictionary(FData));
end;
...
begin
  Result := CefStringFreeAndGet(PCefSslCertPrincipal(FData)
    .get_common_name(FData));
end;

function TCefSslCertPrincipalRef.GetCountryName: ustring;
begin
  Result := CefStringFreeAndGet(PCefSslCertPrincipal(FData)
    .get_country_name(FData));
end;

function TCefSslCertPrincipalRef.GetDisplayName: ustring;
begin
  Result := CefStringFreeAndGet(PCefSslCertPrincipal(FData)
    .get_display_name(FData));
end;
...
begin
  Result := CefStringFreeAndGet(PCefSslCertPrincipal(FData)
    .get_state_or_province_name(FData));
end;
...
class function TCefSslCertPrincipalRef.UnWrap(data: Pointer)
  : ICefSslCertPrincipal;
begin
  if data <> nil then
...
begin
  Result := TCefSslCertPrincipalRef.UnWrap(PCefSslInfo(FData)
    .get_issuer(FData));
end;
...
begin
  Result := TCefBinaryValueRef.UnWrap(PCefSslInfo(FData)
    .get_serial_number(FData));
end;
...
constructor TCefFastPdfPrintCallback.create(const proc
...
class function TCefRunContextMenuCallbackRef.UnWrap(data: Pointer)
...
out data: Pointer; out dataSize: NativeUInt): Boolean;
begin
  Result := PCefResourceBundle(FData).get_data_resource(FData, resourceId, data,
    dataSize) <> 0;
end;
...
begin
  Result := CefStringFreeAndGet(PCefResourceBundle(FData)
    .get_localized_string(FData, stringId));
end;
