...
{$IFDEF WINDOWS}
uses WinApi.Windows, WinApi.Messages, Classes, SysUtils, Forms, Controls, Dialogs, Graphics,
  ExtCtrls, Menus, dx_vgcore, dx_scene, WinApi.ActiveX;
{$ENDIF}
...
begin
  ...
  Result := true;
  { Render }
  if CheckDxError(FDev.BeginScene) then Exit;
...
begin
  ...
  begin
    { front }
    Ver^ := ColorTexVertexNormal(StartPoint.X, StartPoint.Y, StartPoint.Z, 0, 0, 0, dxOpacity(Material.NativeDiffuse, Opacity), 0, 0); System.Inc(Ver);
    Ver^ := ColorTexVertexNormal(EndPoint.X, EndPoint.Y, EndPoint.Z, 0, 0, 0, dxOpacity(Material.NativeDiffuse, Opacity), 1, 1); System.Inc(Ver);
    { indexs }
    ...
    begin
      for i := 0 to 0 do
      begin
        Idx^ := {(VBLockPos div SizeOf(TdxColorTexVertexNormal)) + }(i * 2) + 0; System.Inc(Idx);
        Idx^ := {(VBLockPos div SizeOf(TdxColorTexVertexNormal)) + }(i * 2) + 1; System.Inc(Idx);
      end;
      IB.Unlock;
    end;
    { unlock }
...
begin
  ...
  begin
    ...
    n := dxVectorScale(n, -1);
    Ver^ := ColorTexVertexNormal(A.X, A.Y, B.Z, n.x, n.y, n.z, dxOpacity(Material.NativeDiffuse, Opacity), tx1, ty1); System.Inc(Ver);
    Ver^ := ColorTexVertexNormal(B.X, A.Y, B.Z, n.x, n.y, n.z, dxOpacity(Material.NativeDiffuse, Opacity), tx2, ty1); System.Inc(Ver);
    Ver^ := ColorTexVertexNormal(B.X, A.Y, A.Z, n.x, n.y, n.z, dxOpacity(Material.NativeDiffuse, Opacity), tx2, ty2); System.Inc(Ver);
    Ver^ := ColorTexVertexNormal(A.X, A.Y, A.Z, n.x, n.y, n.z, dxOpacity(Material.NativeDiffuse, Opacity), tx1, ty2); System.Inc(Ver);
    { right }
    ...
    n := dxVectorScale(n, -1);
    Ver^ := ColorTexVertexNormal(B.X, A.Y, B.Z, n.x, n.y, n.z, dxOpacity(Material.NativeDiffuse, Opacity), tx1, ty1); System.Inc(Ver);
    Ver^ := ColorTexVertexNormal(B.X, B.Y, B.Z, n.x, n.y, n.z, dxOpacity(Material.NativeDiffuse, Opacity), tx2, ty1); System.Inc(Ver);
    Ver^ := ColorTexVertexNormal(B.X, B.Y, A.Z, n.x, n.y, n.z, dxOpacity(Material.NativeDiffuse, Opacity), tx2, ty2); System.Inc(Ver);
    Ver^ := ColorTexVertexNormal(B.X, A.Y, A.Z, n.x, n.y, n.z, dxOpacity(Material.NativeDiffuse, Opacity), tx1, ty2); System.Inc(Ver);
    { left }
    ...
    n := dxVectorScale(n, -1);
    Ver^ := ColorTexVertexNormal(A.X, B.Y, B.Z, n.x, n.y, n.z, dxOpacity(Material.NativeDiffuse, Opacity), tx1, ty1); System.Inc(Ver);
    Ver^ := ColorTexVertexNormal(A.X, A.Y, B.Z, n.x, n.y, n.z, dxOpacity(Material.NativeDiffuse, Opacity), tx2, ty1); System.Inc(Ver);
    Ver^ := ColorTexVertexNormal(A.X, A.Y, A.Z, n.x, n.y, n.z, dxOpacity(Material.NativeDiffuse, Opacity), tx2, ty2); System.Inc(Ver);
    Ver^ := ColorTexVertexNormal(A.X, B.Y, A.Z, n.x, n.y, n.z, dxOpacity(Material.NativeDiffuse, Opacity), tx1, ty2); System.Inc(Ver);
    { back }
    ...
    n := dxVectorScale(n, -1);
    Ver^ := ColorTexVertexNormal(B.X, B.Y, B.Z, n.x, n.y, n.z, dxOpacity(Material.NativeDiffuse, Opacity), tx1, ty1); System.Inc(Ver);
    Ver^ := ColorTexVertexNormal(A.X, B.Y, B.Z, n.x, n.y, n.z, dxOpacity(Material.NativeDiffuse, Opacity), tx2, ty1); System.Inc(Ver);
    Ver^ := ColorTexVertexNormal(A.X, B.Y, A.Z, n.x, n.y, n.z, dxOpacity(Material.NativeDiffuse, Opacity), tx2, ty2); System.Inc(Ver);
    Ver^ := ColorTexVertexNormal(B.X, B.Y, A.Z, n.x, n.y, n.z, dxOpacity(Material.NativeDiffuse, Opacity), tx1, ty2); System.Inc(Ver);
    { top }
    ...
    Ver^ := ColorTexVertexNormal(A.X, B.Y, B.Z, n.x, n.y, n.z, dxOpacity(Material.NativeDiffuse, Opacity), tx1, ty1); System.Inc(Ver);
    Ver^ := ColorTexVertexNormal(B.X, B.Y, B.Z, n.x, n.y, n.z, dxOpacity(Material.NativeDiffuse, Opacity), tx2, ty1); System.Inc(Ver);
    Ver^ := ColorTexVertexNormal(B.X, A.Y, B.Z, n.x, n.y, n.z, dxOpacity(Material.NativeDiffuse, Opacity), tx2, ty2); System.Inc(Ver);
    Ver^ := ColorTexVertexNormal(A.X, A.Y, B.Z, n.x, n.y, n.z, dxOpacity(Material.NativeDiffuse, Opacity), tx1, ty2); System.Inc(Ver);
    { bottom }
    ...
    n := dxVectorScale(n, -1);
    Ver^ := ColorTexVertexNormal(A.X, A.Y, A.Z, n.x, n.y, n.z, dxOpacity(Material.NativeDiffuse, Opacity), tx1, ty1); System.Inc(Ver);
    Ver^ := ColorTexVertexNormal(B.X, A.Y, A.Z, n.x, n.y, n.z, dxOpacity(Material.NativeDiffuse, Opacity), tx2, ty1); System.Inc(Ver);
    Ver^ := ColorTexVertexNormal(B.X, B.Y, A.Z, n.x, n.y, n.z, dxOpacity(Material.NativeDiffuse, Opacity), tx2, ty2); System.Inc(Ver);
    Ver^ := ColorTexVertexNormal(A.X, B.Y, A.Z, n.x, n.y, n.z, dxOpacity(Material.NativeDiffuse, Opacity), tx1, ty2); System.Inc(Ver);
    ...
    begin
      for i := 0 to 5 do
      begin
        Idx^ := {(VBLockPos div SizeOf(TdxColorTexVertexNormal)) +} (i * 4) + 0; System.Inc(Idx);
        Idx^ := {(VBLockPos div SizeOf(TdxColorTexVertexNormal)) +} (i * 4) + 1; System.Inc(Idx);
        Idx^ := {(VBLockPos div SizeOf(TdxColorTexVertexNormal)) +} (i * 4) + 3; System.Inc(Idx);
        Idx^ := {(VBLockPos div SizeOf(TdxColorTexVertexNormal)) +} (i * 4) + 3; System.Inc(Idx);
        Idx^ := {(VBLockPos div SizeOf(TdxColorTexVertexNormal)) +} (i * 4) + 1; System.Inc(Idx);
        Idx^ := {(VBLockPos div SizeOf(TdxColorTexVertexNormal)) +} (i * 4) + 2; System.Inc(Idx);
      end;
      IB.Unlock;
    end;
    { unlock }
...
begin
  ...
  if Length(MeshData.MeshVertices) * SizeOf(TdxColorTexVertexNormal) > VBSize then Exit;
...
begin
  ...
  if Length(Vertices) * SizeOf(TdxColorTexVertexNormal) > VBSize then Exit;
  ...
  begin
    ...
    begin
      ...
      begin
        for i := 0 to Length(MeshData.MeshIndices) - 1 do
        begin
          Idx^ := {(VBLockPos div SizeOf(TdxColorTexVertexNormal)) + }MeshData.MeshIndices[i]; System.Inc(Idx);
        end;
        IB.Unlock;
      end;
      { unlock }
...
//      FDev.SetRenderState(D3DRS_CULLMODE, D3DCULL_CCW);
      ...
      begin
        ...
        begin
          Idx^ := {(VBLockPos div SizeOf(TdxColorTexVertexNormal)) +} 0; System.Inc(Idx);
          Idx^ := {(VBLockPos div SizeOf(TdxColorTexVertexNormal)) +} 3; System.Inc(Idx);
          Idx^ := {(VBLockPos div SizeOf(TdxColorTexVertexNormal)) +} 1; System.Inc(Idx);
          Idx^ := {(VBLockPos div SizeOf(TdxColorTexVertexNormal)) +} 1; System.Inc(Idx);
          Idx^ := {(VBLockPos div SizeOf(TdxColorTexVertexNormal)) +} 3; System.Inc(Idx);
          Idx^ := {(VBLockPos div SizeOf(TdxColorTexVertexNormal)) +} 2; System.Inc(Idx);
          IB.Unlock;
        end;
        { unlock }
        VB.Unlock;
...
{    if Assigned(_Direct3DCreate9Ex) then
    ...
    begin
      if CheckDxError(FDev.CreateTexture(Bitmap.Width, Bitmap.Height, 1, D3DUSAGE_DYNAMIC, D3DFMT_A8R8G8B8, D3DPOOL_DEFAULT, Tex, nil)) then Exit;
      Tex._AddRef;
      Bitmap.NeedUpdate := true;
    end;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if FCurrentStates[rs2DScene] then
          begin
            pVertices^ := ColorTexVertexNormal(x + 0 + 0.5, y + 0 + 0.5, 0, 0, 0, 0, dxOpacity(Material.NativeDiffuse, Opacity), tx1, ty1); System.Inc(pVertices);
            pVertices^ := ColorTexVertexNormal(x + w + 0.5, y + 0 + 0.5, 0, 0, 0, 0, dxOpacity(Material.NativeDiffuse, Opacity), tx2, ty1); System.Inc(pVertices);
            pVertices^ := ColorTexVertexNormal(x + w + 0.5, y + h + 0.5, 0, 0, 0, 0, dxOpacity(Material.NativeDiffuse, Opacity), tx2, ty2); System.Inc(pVertices);
            pVertices^ := ColorTexVertexNormal(x + 0 + 0.5, y + h + 0.5, 0, 0, 0, 0, dxOpacity(Material.NativeDiffuse, Opacity), tx1, ty2); System.Inc(pVertices);
          end
          else
          begin
            scale := 0.02;
            pVertices^ := ColorTexVertexNormal((x + 0) * scale, 0, (y + h) * scale, 0, 0, 0.0, dxOpacity(Material.NativeDiffuse, Opacity), tx1, ty1); System.Inc(pVertices);
            pVertices^ := ColorTexVertexNormal((x + w) * scale, 0, (y + h) * scale, 0, 0, 0.0, dxOpacity(Material.NativeDiffuse, Opacity), tx2, ty1); System.Inc(pVertices);
            pVertices^ := ColorTexVertexNormal((x + w) * scale, 0, (y + 0) * scale, 0, 0, 0.0, dxOpacity(Material.NativeDiffuse, Opacity), tx2, ty2); System.Inc(pVertices);
            pVertices^ := ColorTexVertexNormal((x + 0) * scale, 0, (y + 0) * scale, 0, 0, 0.0, dxOpacity(Material.NativeDiffuse, Opacity), tx1, ty2); System.Inc(pVertices);
          end;
