...
procedure AABBInclude(var bb : TdxAABB; const p : TdxVector);
begin
   if p.V[0]<bb.min.V[0] then bb.min.V[0]:=p.V[0];
   if p.V[0]>bb.max.V[0] then bb.max.V[0]:=p.V[0];
   if p.V[1]<bb.min.V[1] then bb.min.V[1]:=p.V[1];
   if p.V[1]>bb.max.V[1] then bb.max.V[1]:=p.V[1];
   if p.V[2]<bb.min.V[2] then bb.min.V[2]:=p.V[2];
   if p.V[2]>bb.max.V[2] then bb.max.V[2]:=p.V[2];
end;
...
var
   ...
   d1, d2, d3, d4: Single;
begin
    a1:= M.M[X].V[X]; b1:= M.M[X].V[Y];
    c1:= M.M[X].V[Z]; d1:= M.M[X].V[W];
    a2:= M.M[Y].V[X]; b2:= M.M[Y].V[Y];
    c2:= M.M[Y].V[Z]; d2:= M.M[Y].V[W];
    a3:= M.M[Z].V[X]; b3:= M.M[Z].V[Y];
    c3:= M.M[Z].V[Z]; d3:= M.M[Z].V[W];
    a4:= M.M[W].V[X]; b4:= M.M[W].V[Y];
    c4:= M.M[W].V[Z]; d4:= M.M[W].V[W];
...
var
   f : Single;
begin
   f:=M.M[0].V[1]; M.M[0].V[1]:=M.M[1].V[0]; M.M[1].V[0]:=f;
   f:=M.M[0].V[2]; M.M[0].V[2]:=M.M[2].V[0]; M.M[2].V[0]:=f;
   f:=M.M[0].V[3]; M.M[0].V[3]:=M.M[3].V[0]; M.M[3].V[0]:=f;
   f:=M.M[1].V[2]; M.M[1].V[2]:=M.M[2].V[1]; M.M[2].V[1]:=f;
   f:=M.M[1].V[3]; M.M[1].V[3]:=M.M[3].V[1]; M.M[3].V[1]:=f;
   f:=M.M[2].V[3]; M.M[2].V[3]:=M.M[3].V[2]; M.M[3].V[2]:=f;
end;
...
begin
   ...
   if (mat.M[0].V[0]>mat.M[1].V[1]) and (mat.M[0].V[0]>mat.M[2].V[2]) then begin  // Row 0:
